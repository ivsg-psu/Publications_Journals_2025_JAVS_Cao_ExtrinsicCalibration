function Transformation_Matrix = fcn_LiDARPoseEstimation_CreateTransformationMatrix(translation, x_angle,y_angle,z_angle)
% fcn_LiDARPoseEstimation_CreateTransformationMatrix creates a homogeneous transformation matrix
% FORMAT:
%
...
% Transformation_Matrix = se3(Transformation_Matrix);